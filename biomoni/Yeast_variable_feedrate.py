...
class Yeast_vf(Model):     #Dependent on base class
    ...
    def create_controls(self, experiment):
        ...
        c = {"feed_factor" : experiment.metadata.loc["feed_factor"],"feed_on" : experiment.metadata.loc["feed_on"], "feed_rate" : experiment.metadata.loc["feed_rate"], "csf" : experiment.metadata.loc["csf"]
    ...
    def kinetics(self, t, y, p, c, yields):
        ...
        Monod_O2 = 1   #cO/(cO+Ko) for dependency on oxygen
